...
@include('includes.header-popup')
	...
	<div id="content">
        ...
        <div style="float:right;margin-right: 10px;"  class="btn_24_blue">   
          @include('objection.search.newsearch',['tableid'=>'baskettbl', 'action' => 'objectionbaskettable?', 'searchid' => '33'])
				...
				<div class="widget_wrap">					
					<div class="widget_content">						
						<table id="baskettbl" class="display select">
...
<script type="text/javascript">
  ...
  function submitForm(){
    ...
    xhr = $.ajax({
            url: 'objectionbaskettable?id={{$id}}&term={{$term}}&test=manual&ts_='+timestamp,
            type: 'GET',
...
$(document).ready(function (){
   // Array holding selected row IDs
    ...
    var tbl =  $('#baskettbl').DataTable({
       "processing": false,
            "serverSide": false,
            /*"dom": '<"toolbar">frtip',*/
            "ajax": {
                "type": "GET",
                "url": 'objectionbaskettable?term={{$term}}',
   ...
   /*$('#baskettbl').on('click', 'tbody td, thead th:first-child', function(e){
