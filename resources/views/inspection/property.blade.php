...
var table = $('#proptble').DataTable({
		       ...
		       // ajax: '{{ url("inspectionproperty") }}',
		        ...
		        "columns": [
			        ...
			        {"data": "ma_address1", "name": "propertstatus","visible":false}, 
			        {"data": "ma_address2", "name": "ishasbldg","visible":false}, 
			        {"data": "ma_address3", "name": "propertstatus","visible":false}, 
			        {"data": "ma_address4", "name": "ishasbldg","visible":false}, 
