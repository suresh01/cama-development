...
<div id="tab4">
	<h4>{{__('existspropertyregisyter.Building')}} </h4>
	<p>
		{{__('existspropertyregisyter.Account_Number')}} = <span id="bldglabel"></span>
	</p>

	@if($iseditable == 1)<button onclick="openbldg()" id="addbldg" name="btnadduser" type="button" class="btn_small btn_blue"><span>{{__('existspropertyregisyter.Add_Building')}}</span></button>@endif
		...
		<div class="widget_content">						
			...
			<thead style="text-align: left;">
	  		<tr>
				...
				<th>{{__('existspropertyregisyter.Building_Number')}}</th>
				<th>{{__('existspropertyregisyter.Building_Number1S')}}</th>
				<th>{{__('existspropertyregisyter.Building_Category_Type')}}</th>
				<th>{{__('existspropertyregisyter.Building_Storey')}}</th>
				<th>{{__('existspropertyregisyter.Building_Structure')}}</th>
				<th>{{__('existspropertyregisyter.Roof_Type')}}</th>
				<th>{{__('existspropertyregisyter.Building_Type')}}</th>
				<th>{{__('existspropertyregisyter.Building_Storey')}}</th>
				<th>{{__('existspropertyregisyter.Building_Condition')}}</th>
				<th>{{__('existspropertyregisyter.Building_Position')}}</th>
				<th>{{__('existspropertyregisyter.Building_Structure')}}</th>
				<th>{{__('existspropertyregisyter.Roof_Type')}}</th>
				<th>{{__('existspropertyregisyter.Wall_Type')}}</th>
				<th>{{__('existspropertyregisyter.Floor_Type')}}</th>
				<th>{{__('existspropertyregisyter.Ccc_Date')}}</th>
				<th>{{__('existspropertyregisyter.Occupied_Date')}}</th>
				<th>{{__('existspropertyregisyter.Main_Building')}}</th>
				<th>{{__('existspropertyregisyter.Action')}}</th>
				<th>{{__('existspropertyregisyter.Actioncode')}}</th>
				<th>{{__('existspropertyregisyter.Blsdgid')}}</th>
				<th>{{__('existspropertyregisyter.Account')}}</th>
			</tr>
			</thead>
			<tbody></tbody>
			</table>
			...
			<table  id="bldgartable1" class="display" style="width:100%">
				<div class="social_activities">
					...
					<div class="comments_s">
						<div class="block_label">
							{{__('existspropertyregisyter.Building_Number')}}<span id="disbldgno">{{__('existspropertyregisyter.All')}}</span>
				...
				<thead style="text-align: left;">
					<tr>
						...
						<th>{{__('existspropertyregisyter.Building_Number')}}</th>
						<th>{{__('existspropertyregisyter.Area_Type')}}</th>
						<th>{{__('existspropertyregisyter.Area_Category')}}</th>
						<th>{{__('existspropertyregisyter.Area_Use')}}</th>
						<th>{{__('existspropertyregisyter.Area_Count')}}</th>
						<th>{{__('existspropertyregisyter.Total_Size')}}</th>
						<th>{{__('existspropertyregisyter.Ceiling_Type')}}</th>
						<th>{{__('existspropertyregisyter.Floor_Type')}}</th>
						<th>{{__('existspropertyregisyter.Wall_Type')}}</th>
						<th>{{__('existspropertyregisyter.Area_Description')}}</th>
						<th>{{__('existspropertyregisyter.Reff_Information')}}</th>
						<th>{{__('existspropertyregisyter.Area_Type')}}</th>
						<th>{{__('existspropertyregisyter.Area_Category')}}</th>
						<th>{{__('existspropertyregisyter.Area_Level')}}</th>
						<th>{{__('existspropertyregisyter.Area_Zone')}}</th>
						<th>{{__('existspropertyregisyter.Area_Use')}}</th>
						<th>{{__('existspropertyregisyter.Area_Description')}}</th>
						<th>{{__('existspropertyregisyter.Dimention')}}</th>
						<th>{{__('existspropertyregisyter.Area_Count')}}</th>
						<th>{{__('existspropertyregisyter.Measurement')}}</th>
						<th>{{__('existspropertyregisyter.Unit_Of_Measurement')}}</th>
						<th>{{__('existspropertyregisyter.Total_Size')}}</th>
						<th>{{__('existspropertyregisyter.Floor_Type')}}</th>
						<th>{{__('existspropertyregisyter.Wall_Type')}}</th>
						<th>{{__('existspropertyregisyter.Ceilling_Type')}}</th>
						<th>{{__('existspropertyregisyter.Action')}}</th>
						<th>{{__('existspropertyregisyter.Actioncode')}}</th>
						<th>{{__('existspropertyregisyter.Detailid')}}</th>
					</tr>
				</thead>
				<tbody>
				...
				<ul>
					<li>
						...
						<div class="form_grid_12">
							<label class="field_title" id="lusername" for="username">{{__('existspropertyregisyter.Building_Number')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Building_Category')}} <span class="req">*</span></label>
							<div  class="form_input">
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Building_Type')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Building_Storey')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Building_Condition')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Building_Position')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Building_Structure')}}<span class="req">*</span></label>
			...
			<div  class="grid_6 ">
				<ul>
					<li >
						...
						<div class="form_grid_12">
							<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Roof_Type')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Wall_Type')}}<span class="req">*</span></label>
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Floor_Type')}}<span class="req">*</span></label>
							<div  class="form_input">
						...
						<div class="form_grid_12">
							<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Ccc_Date')}}<span class="req">*</span></label>
							<div  class="form_input">
						...
						<div class="form_grid_12">
							<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Occupied_Date')}} <span class="req">*</span></label>
							<div  class="form_input">
						...
						<div class="form_grid_12">
							<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Main_Building')}} <span class="req">*</span></label>
							<div  class="form_input">
	...
	<div style="display:none;" id="bldgardetail1" >
		<div class="social_activities">
					...
					<div class="comments_s">
						<div class="block_label">
							{{__('existspropertyregisyter.Building_Number')}}<span id="dispbldgnum2"></span>
						</div>
					</div>
					...
					<br>
								...
								<div class="form_grid_12">
									<label class="field_title" id="lusername" for="username">{{__('existspropertyregisyter.Reff_Information')}} <span class="req">*</span></label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Area_Type')}}</label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Area_Category')}}<span class="req">*</span></label>
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Area_Level')}}<span class="req">*</span></label>
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Area_Zone')}}<span class="req">*</span></label>
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Area_Use')}} <span class="req">*</span></label>
								...
								<div class="form_grid_12">
									<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Area_Description')}} </label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Celing_Type')}} <span class="req">*</span></label>
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Dimention')}}<span class="req">*</span></label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Area_Count')}} <span class="req">*</span></label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="llevel" for="level">{{__('existspropertyregisyter.Measurement')}}<span class="req">*</span></label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Unit_Of_Measurement')}} <span class="req">*</span></label>
									<div  class="form_input">
								...
								<div class="form_grid_12">
									<label class="field_title" id="lposition" for="position">{{__('existspropertyregisyter.Total_Size')}} <span class="req">*</span></label>
									<div  class="form_input">
