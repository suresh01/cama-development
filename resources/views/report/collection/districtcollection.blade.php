...
<title>Summary By District</title>
		...
		<div class="grid_container">
			<div class="grid_12">	
				...
				<div style="float:right;margin-right: 10px;"  class="btn_24_blue">	
					...
					@include('report.collection.districtsearch')
				</div>
				<br>
...
//console.log(table.rows('.selected').data()); href="generatecollectionbldg" 
			...
			if (tilte == null || tilte == "") {
				...
				window.location = "generatecollectiondistrict?title="+tilte+"&termid="+id;
			}
...
$(document).ready(function (){
	var table = $('#proptble').DataTable({
		        ...
		        "columns": [
			        ...
			        {"data": null, "name": "sno"},
			        {"data": "bldgcategory", "name": "account number"},
			        {"data": "district", "name": "fileno"},
