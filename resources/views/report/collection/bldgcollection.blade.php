		...
		<div class="grid_container">
			<div class="grid_12">	
				...
				<div style="float:right;margin-right: 10px;"  class="btn_24_blue">	
					...
					@include('report.collection.searchbldg')
				</div>
				<br>
...
//console.log(table.rows('.selected').data());  href="generatecollectionbldg"
			...
			var tilte = prompt("Report Title", "STATISTIK KUTIPAN MENGIKUT KAT. BANGUNAN SEHINGGA PENGGAL");

			if (tilte == null || tilte == "") {
				return;
			} else {
				var id = $('#value_Term').val();
				window.location = "generatecollectionbldg?title="+tilte+"&termid="+id;
			}
