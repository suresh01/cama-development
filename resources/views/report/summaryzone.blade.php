		...
		<div class="grid_container">
			<div class="grid_12">	
				...
				<div style="float:right;margin-right: 10px;"  class="btn_24_blue">	
					<a href="generatesummaryzone" >Generate Report</a>				
					@include('report.collection.zonesearch')
				</div>
				<br>
...
$(document).ready(function (){
	var table = $('#proptble').DataTable({
		        ...
		        "columns": [
			        ...
			        {"data": "propcount", "name": "zone"},
			        {"data": "vt_approvednt", "name": "subzone"},
			        {"data": "vt_approvedtax", "name": "owner"}
		   		],
