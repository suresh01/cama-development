...
@include('includes.header', ['page' => 'report'])
	...
	<div id="content">
		<div class="grid_container">
			<div class="grid_12">	
				...
				<div style="float:right;margin-right: 10px;"  class="btn_24_blue">	
					...
					@include('report.search.search',['tableid'=>'proptble', 'action' => 'valuationdatatable', 'searchid' => $msearchid])	
				</div>
				<br>
		...
		<form style="display: hidden;" id="generateform" method="GET" action="http://{{$serverhost}}:8002/generateValuationData">
            @csrf
