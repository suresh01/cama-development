		        ...
		        "columns": [
			        ...
			        {"data": function(data){
			        	...
			        	var action = "";
							...
							var editaction ="<span><a class='action-icons c-edit' onclick='editBasket("+data.tbldg_id+")' href='#' title='Edit'>Edit</a></span> " +
							"<span><a class='action-icons c-Delete delete_tenant' onclick='deleteBasket("+data.tbldg_id+")' href='#' title='Delete'>Delete</a></span>";

							if(data.tbldg_approvalbldgstatus_id == '1'){
								action = editaction +  '<span><a style="height: 20px; width: 20px; margin-top: 5px; background: url(../images/sprite-icons/icons-color.png) no-repeat;background-position: 0px 0px !important;display: inline-block; float: left;" onclick="approve('+data.tbldg_id+',1)"  title="Submit To Approve" href="#"></a></span>';							
							} else if(data.tbldg_approvalbldgstatus_id == '2'){
								action =   '<span><a style="height: 20px; width: 20px; margin-top: 5px; background: url(../images/sprite-icons/icons-color.png) no-repeat;background-position: 0px 0px !important;display: inline-block; float: left;" onclick="approve('+data.tbldg_id+',2)"  title="Approve" href="#"></a></span>';							
								...
								action =  editaction +  '<span><a style="height: 20px; width: 20px; margin-top: 5px; background: url(../images/sprite-icons/icons-color.png) no-repeat;background-position: 0px 0px !important;display: inline-block; float: left;" onclick="approve('+data.tbldg_id+',4)"  title="Submit to Revise Approval" href="#"></a></span>';							
