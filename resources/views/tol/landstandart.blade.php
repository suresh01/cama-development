	...
	<div id="content">
		...
		<div id="basket_table" class="grid_12">			
			...
			<div class="form_input">
				...
				<button id="addtrans" style="float:right;" onclick="openBasket()" name="btnadduser" type="button" class="btn_small btn_blue"><span>Add  Land Standard</span></button>
				<br>
			</div>
					...
					<table style="width: 100%" id="landtable" class="display">
						...
						<div class="social_activities">
							...
							<select id='testSelect1' style="float: right;" multiple>
								...
								<option value='3'>Subzone</option>
								<option value='4'>Property Category</option>
								<option value='5'>Property Type</option>
								<option value='6'>Property Storey</option>
								<option value='7'>Standard Area</option>
								<option value='8'>Next Area</option>
								<option value='9'>Max Level</option>
								<option value='10'>Update by / Update date</option>
							</select>
