...
<div id="container">
    ...
    margin: 0 0 0 0;
">Computer Assisted Mass Appraisal </p>
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
	...
	<div id="nav" class="stats_bar">		
		...
		<ul>					
			<li><a style="{{ $page == 'dash' ? 'background-color: #95C9F5;' : '' }}" href="dashboard"><span class="stats_icon dashboard"></span><span class="label">Home</span></a></li>
			<li class="dropdown-submenu dropdown"><a style="{{ $page == 'dataenquery' ? 'background-color: #95C9F5;' : '' }}" class="test" tabindex="-1" href="#"><span class="stats_icon data_enqury"></span><span class="label">Data Enquery</span></a>
			...
			<li class="dropdown-submenu dropdown"><a style="{{ $page == 'datamaintenance' ? 'background-color: #95C9F5;' : '' }}" class="test" tabindex="-1" href="#"><span class="stats_icon data_maintance"></span><span class="label">Data Maintenance</span></a>
				<ul class="mainNav dropdown-menu" style="display:none">
			        ...
			        <li class="dropdown-submenu">
			            <a style="padding: 5px;width: 172px;" onclick="check_access('38','plan')" class="test" href="#">Plan Registeration<span class="caret"></span></a>
			        </li>
			        <li class="dropdown-submenu">
			        ...
			        <li class="dropdown-submenu">
			            ...
			            <ul class="dropdown-menu child" style="display:none;">
							...
							<li>
								<a style="padding: 5px;width: 172px;" onclick="check_access('394','addresslog');" href="#">Property Address Log</a>
							</li>
			            </ul>
		          	</li>
    			</ul>
			</li>
			<li class="dropdown-submenu dropdown"><a style="{{ $page == 'TOL' ? 'background-color: #95C9F5;' : '' }}"  href="#" class="test"><span class="stats_icon finished_work_sl"></span><span class="label">Tone of List</span></a>
				<ul class="dropdown-menu" style="display:none">
			        <li class="dropdown-submenu">
			            <a style="padding: 5px;width: 172px;"  onclick="check_access('41','tonebasket')" class="test" href="#">Tone Basket<span class="caret"></span></a>
			        </li>
			        <li class="dropdown-submenu">
			...
			<li class="dropdown-submenu dropdown"><a style="{{ $page == 'VP' ? 'background-color: #95C9F5;' : '' }}"  href="#" class="test"><span class="stats_icon finished_work_sl"></span><span class="label">Valuation Process</span></a>
				<ul class="dropdown-menu" style="display:none">
			        <li class="dropdown-submenu">
			...
			<li class="dropdown-submenu dropdown"><a style="{{ $page == 'report' ? 'background-color: #95C9F5;' : '' }}"  href="#" class="test"><span class="stats_icon finished_work_sl"></span><span class="label">Report</span></a>
				<ul class="mainNav dropdown-menu" style="display:none">
			        <li class="dropdown-submenu">
			        ...
			        <li class="dropdown-submenu">
			            <a style="padding: 5px;width: 172px;" onclick="check_access('714','statistical')" class="test" href="#">Simulation Function<span class="caret"></span></a>
			        </li>
