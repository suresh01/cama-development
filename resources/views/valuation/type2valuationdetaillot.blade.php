						...
						<div class=" page_content">
							<div class="invoice_container">	
								...
								<div class="grid_12 invoice_details">
									...
									<div style="display: none;"  class="widget_wrap collapsible_widget">
										<div class="widget_top active">
											<span class="h_icon"></span>
												...
												<div class="form_grid_12">
													<div class="form_grid_6">									
														...
														<div class="form_input">
															<input id="add_description" required="true"  name="add_description" onchange="additionalCal()" type="text"  value="" />
														</div>
								...
								<fieldset>
									...
									<div style="float: right;" class="grid_5 form_container left_label">
											<ul>
												...
												<div class="form_grid_8">
													<div  class="form_input">
														<input id="taxvaluerdiscretion" class="right-text " tabindex="1" style="width: 100%;" name="taxvaluerdiscretion" value="" onchange="taxDriveCalculation()" type="text" maxlength="100" >
													</div>
													<span class=" label_intro"></span>
												</div>
												@if($termtype == 2)
													<div class="form_grid_4">
														<label class="field_title"   id="accnumberlbl" style="width: 100%;" for="username">Derive Value(%)<span class="req">*</span></label>
														
													</div>
													<div class="form_grid_2">
														<input id="taxdriverate" class="right-text " tabindex="1" style="width: 100%;" value="0.0" name="taxdriverate" value="" onchange="taxDriveCalculation()" type="text" maxlength="100" >
														
													</div>
													<div class="form_grid_6">
														<div style=" margin-left: 5%;" class="form_input">
															<input id="taxdrivevalue" class="right-text " tabindex="1" style="width: 135%;" value="0.0" readonly="true" name="taxdrivevalue" value="" type="text" maxlength="100" >
														</div>
														<span class=" label_intro"></span>
													</div>
												@else
													<input id="taxdriverate" class="right-text " tabindex="1" style="width: 100%;" value="0.0" name="taxdriverate" value="" onchange="taxDriveCalculation()" type="hidden" maxlength="100" >
													<input id="taxdrivevalue" class="right-text " tabindex="1" style="width: 135%;" value="0.0" readonly="true" name="taxdrivevalue" value="" type="hidden" maxlength="100" >
												@endif
													<div class="form_grid_4">
									...
									<div class="grid_5 form_container left_label">
										<ul>
											<li>													
												<br /><br /><br /><br /><br />@if($termtype == 2)<br /><br /><br />@endif
												<div class="form_grid_4">
...
<script>
	...
	function taxDriveCalculation(){
		...
		@else 
			...
			var taxdriverate = removeCommas($('#taxdriverate').val());

			var grossnt = Number(landtotal) +  Number(additionaltotal) + Number(taxvaluerdiscretion);
			console.log(grossnt);
			grossnt = grossnt * (taxdriverate /100);
			console.log(grossnt);
			$('#taxdrivevalue').val(formatMoneyHas(grossnt));
			taxCalculation();
	...
	function taxCalculation2(){
    	...
    	var grossnt = Number(landtotal) + Number(additionaltotal) + Number(taxvaluerdiscretion);
    	console.log(grossnt);
    	var propsednt = customround(grossnt,1);//Math.floor(grossnt/1000)*1000;
	...
	function taxCalculation(){
    	...
    	//var grossnt = Number(landtotal) + Number(additionaltotal) + Number(taxvaluerdiscretion);
    	//console.log(grossnt);
    	var gross = Number(landtotal) + Number(taxvaluerdiscretion);
	...
	@foreach ($tax as $rec)
		...
		@if($termtype == 1)
			formatMoney('taxdrivevalue','{{$rec -> vt_grossvalue}}');
